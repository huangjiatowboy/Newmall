"""
Django settings for new_mall project.
...
SECRET_KEY = '7g7ushbt(f#z)t7ez&x8q1px#!2f@)_)m1qhz7$997r6((yj)w'
...
WSGI_APPLICATION = 'new_mall.wsgi.application'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/0", #数据库地址
        "OPTIONS": {
