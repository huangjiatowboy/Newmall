var vm = new Vue({
    ...
    methods: {
        ...
        get_skus: function(){
            // alert(this.cat)
            // /categories/115/skus/?page=1&page_size=10&ordering=price
            ...
            axios.get(this.host+'/categories/'+this.cat+'/skus/',config)
                .then(response => {
                    this.count = response.data.count;  // 商品总条数
                    this.skus = response.data.results;  // 一页商品

                    for(var i=0; i<this.skus.length; i++){
                        // 指定商品访问的url地址:  /goods/1.html
